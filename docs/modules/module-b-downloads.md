...
#### 1. Host C++ (`host/owl_download_manager_delegate.h/.cc`)
...
| 新增 | `host/owl_download_manager_delegate.h/.cc` |
...
| 新增 | `owl-client-app/Views/Panel/DownloadPanelView.swift` |
| 新增 | `owl-client-app/Views/Panel/DownloadRow.swift` |
